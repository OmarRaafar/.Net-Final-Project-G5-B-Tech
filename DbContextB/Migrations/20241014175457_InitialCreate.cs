...
namespace DbContextB.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProductSpecificationTranslations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TranslatedKey = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    TranslatedValue = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSpecificationTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductSpecificationTranslations_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountBOrderB", x => new { x.DiscountsId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_DiscountBOrderB_Discounts_DiscountsId",
                        column: x => x.DiscountsId,
                        principalTable: "Discounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscountBOrderB_Orders_OrdersId",
                        column: x => x.OrdersId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GatewayResponse = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    OrderId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountBOrderB_OrdersId",
                table: "DiscountBOrderB",
                column: "OrdersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSpecificationTranslations_LanguageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSpecificationTranslations_SpecificationId_LanguageId",
                table: "ProductSpecificationTranslations",
                columns: new[] { "SpecificationId", "LanguageId" },
                unique: true);
