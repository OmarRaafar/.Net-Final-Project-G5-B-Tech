...
namespace ApplicationB.Services_B.Category
{
    public class CategoryService : ICategoryService
    {
        ...
        //    // Check if the category name already exists
        //    var existingCategory = await _categoryRepository
        //                                             .AnyAsync(c => c.Translations.Any(t => t                  
        //                                             .CategoryName.ToLower() == createCategoryDto.Translations.First().CategoryName.ToLower()));
        ...
        //        if (translation.LanguageId == null || translation.LanguageId <= 0)
        //        {
        //            //throw new Exception("LanguageId is missing or invalid.");
        ...
        //        if (createCategoryDto.ProductIds != null && createCategoryDto.ProductIds.Any())
        //        {
        //            throw new Exception("No ProductCategories associated with this Category.");
